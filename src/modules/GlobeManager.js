   ...
   _redirectToExternalPage(hotspot) {
       ...
       gsap.to(transitionOverlay, {
           ...
           onComplete: () => {
               // URLs de redirection
               const redirectUrls = {
                   'grande-barriere': 'https://example.com/grande-barriere',
                   'abysses': 'https://example.com/abysses',
                   'arctique': 'https://example.com/arctique',
                   'plastique': 'https://example.com/plastique',
                   'triangle-corail': 'https://example.com/triangle-corail',
                   'requins': 'https://example.com/requins'
               };
               
               const redirectUrl = redirectUrls[hotspot.id] || 'https://example.com/default';
